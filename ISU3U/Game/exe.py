...
class BuildExe:
    def __init__(self):
        ...
        # 起始py文件
        self.script = "new 1.py"
        # 游戏名
        self.project_name = "希理的游戏"
        # 游戏site
        ...
        # 游戏版权
        self.copyright = "Copyright (c) 2018 希理."
        # 游戏描述
        self.project_description = "希理所制作的游戏"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = None
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = []
        # 额外需要的python库名
        self.extra_modules = [pygame,os,random,time,sys]
        # 需要排除的python库
